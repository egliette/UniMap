...
public class RangedEnemyAI : MonoBehaviour
{
    ...
    {  
        ...
        Quaternion lookRotation = Quaternion.LookRotation(new Vector3(direction.x, direction.y-m_YOffset, direction.z));
        var bullet = Instantiate(m_BulletPrefab, m_ShootingPoint.position, lookRotation);
    }
